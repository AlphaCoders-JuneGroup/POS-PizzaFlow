...
class DeliveryDispatchSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $samples = [
            ...
            [
                'order_number' => 'PF-D1005',
                'status' => 'delivered',
                'fulfillment_type' => 'delivery',
                'delivery_address' => '12 Ward Place',
                'delivery_city' => 'Colombo',
                'delivery_landmark' => 'White gate',
                'delivery_instructions' => 'Hand to customer.',
                'items' => [
                    ['name' => 'BBQ Chicken', 'qty' => 1, 'price' => 2490],
                ],
                'subtotal' => 2490,
                'delivery_fee' => 250,
                'total' => 2740,
                ...
                'dispatched_at' => now()->subMinutes(90),
        ...
        foreach ($samples as $sample) {
            ...
            $payload = [
                ...
                'payment_status' => $sample['payment_status'] ?? 'Pending',
                ...
                'delivered_at' => $sample['delivered_at'] ?? null,
